        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className='contLine'>
            ...
            <div className='contInputs'>
              ...
              <select id="category">
                <option value={null} selected>Seleccionar una categoría</option>
          ...
          <div className='contLine'>
            ...
            <div className='contInputs'>
              ...
              <select id="city">
                <option value={null} selected>Seleccionar una ciudad</option>
                {cities.map((city) => (
          ...
          <div id="contFeatures">
            {features.map((feature) => (
              <div>
                <input type="checkbox" id={feature.id} name={feature.title} value={feature.id}/>
